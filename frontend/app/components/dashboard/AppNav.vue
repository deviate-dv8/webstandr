<template>
	<nav>
		<NuxtLink to="/app" class="flex items-center px-4 py-2 text-gray-700 bg-orange-100 rounded-lg">
			<svg class="shrink-0 w-5 h-5 text-orange-500" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path
